        ...
        <div class="modal-body">
            <form action="partials/_manageCart.php" method="post">
                <div class="form-group">
                    ...
                    <input class="form-control" id="address" name="address" placeholder="Valco Hall" type="text" required minlength="3" maxlength="500">
                </div>
                <div class="form-group">
                    <b><label for="address1">Street:</label></b>
                    <input class="form-control" id="address1" name="address1" placeholder="UCC, Cape Coast" type="text">
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6 mb-0">
                        ...
                        <input type="tel" class="form-control" id="phone" name="phone" placeholder="592263311" required minlength="9" maxlength="9">
                        </div>
                    </div>
                 <!--   <div class="form-group col-md-6 mb-0">
